    ...
    return (
        <div className="space-y-6">
            <section className="rounded-3xl border border-zinc-200/80 bg-white/90 p-6 shadow-[0_14px_45px_rgba(15,23,42,0.08)] sm:p-8">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-cyan-700">Coupons & Points</p>
                <h2 className="mt-2 text-3xl font-black tracking-tight text-zinc-900">쿠폰 / 포인트</h2>
                <p className="mt-2 text-sm text-zinc-600">보유한 할인 쿠폰과 포인트 잔액을 확인하고 결제 시 적용할 수 있습니다.</p>
            </section>
            ...
            <section className="grid gap-3 sm:grid-cols-2">
                <Card className="border-zinc-200/80 bg-white/95">
                    <CardContent className="p-4 text-sm">
                        ...
                        <p className="text-2xl font-bold text-zinc-900">{coupons.length}장</p>
                    </CardContent>
                </Card>
                <Card className="border-zinc-200/80 bg-white/95">
                    <CardContent className="p-4 text-sm">
                        ...
                        <p className="text-2xl font-bold text-zinc-900">18,500P</p>
                    </CardContent>
                </Card>
            </section>
            ...
            <section className="space-y-3">
                {coupons.map((coupon) => (
                    <Card key={coupon.id} className="border-zinc-200/80 bg-white/95">
                        <CardHeader className="pb-2">
                            <CardTitle className="text-base text-zinc-900">{coupon.name}</CardTitle>
                        </CardHeader>
                        <CardContent className="space-y-1 text-sm text-zinc-600">
                            <p className="font-semibold text-zinc-900">{couponAmountText(coupon)}</p>
