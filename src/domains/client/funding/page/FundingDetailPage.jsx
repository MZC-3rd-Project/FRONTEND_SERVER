                ...
                <section className="rounded-3xl border border-border bg-card p-6 sm:p-8">
                    <div className="grid gap-5 md:grid-cols-[1.1fr_0.9fr]">
                        ...
                        <div className="space-y-3">
                            ...
                            <p className="text-xs text-muted-foreground">메이커: {campaign.maker}</p>
                            ...
                            <div className="grid gap-1 text-sm text-muted-foreground">
                                <p className="font-semibold text-foreground">{campaign.raised}</p>
                        ...
                        <CardContent className="space-y-2 text-sm text-muted-foreground">
                            {campaign.rewardOptions.map((reward) => (
                                <div key={reward.id} className="rounded-xl border border-border bg-accent/40 p-3">
                                    ...
                                    <p className="text-xs text-muted-foreground">{reward.shipping}</p>
                                    <p className="mt-1 text-sm font-semibold text-foreground">{reward.price}</p>
                                </div>
                            ))}
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-2">
                            {product.reviews.map((review) => (
                                <div key={`${campaign.id}-${review.user}`} className="rounded-xl border border-border bg-accent/40 p-3 text-sm">
